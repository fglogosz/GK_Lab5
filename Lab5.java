...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	...
	public void corkscrew(GL2 gl2, double size)
	{
		...
		gl2.glPushMatrix(); //stos macirzy
		gl2.glColor3f(1.0f, 0.0f, 0.0f);//czerwony
		gl2.glRotated(-90, 0, 0, 1);
		gl2.glTranslated(-5.8,-2.5,0);
		cylinder(gl2, 10, 0.2, 2, 0.2);
		gl2.glPopMatrix();
		gl2.glPushMatrix();
		gl2.glColor3f(1.0f, 1.0f, 1.0f);
		gl2.glScaled(0.35,1,0.35);
		gl2.glBegin(gl2.GL_LINE_STRIP); //  lamane otwarte
		...
		for(double j=0.1,i = 0; i < 300; i++,j+=0.1) 
		 ...
		 gl2.glColor3f(1.0f, 1.0f, 1.0f);//Bialy
		 //gl2.glVertex3d(Math.cos(i/10.0),Math.sin(i/10.0),i/50.0);
	...
	public void Added_Poligon(GL2 gl2, double size)
	{
		...
		Podstawa(gl2 , 6 , 5);	
		gl2.glPushMatrix();
		Triangle(gl2,0.0f, 1.0f, 0.0f );//zielony
		gl2.glPushMatrix();
		...
		Triangle(gl2,1.0f, 0.0f, 0.0f );//czerwony
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(120, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,0.0f, 0.0f, 1.0f );// niebieski
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(180, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 1.0f, 0.0f );// zolty
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(-60, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 0.0f, 1.0f );// fiolet
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(-120, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 1.0f, 1.0f );// bialy
		gl2.glPopMatrix();
